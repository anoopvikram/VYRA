    ...
    <footer className="w-full bg-[#111] text-gray-400 pt-20 pb-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto text-center text-sm mb-12">
        ...
        <div className="flex flex-col gap-3">
          <p className="text-white font-semibold">VYRA</p>
          <a href="#">About Us</a>
          <a href="#">Our Story</a>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>VYRA Street, MG Road</p>
          <p>Bangalore, India</p>
          <p>support@VYRAwear.com</p>
          <p>+91 98765 43210</p>
        </div>
      ...
      <p className="text-center max-w-3xl mx-auto text-sm text-gray-500 mb-8">
        VYRA creates premium streetwear designed for everyday expression.
        Built with quality fabrics, minimal design, and a bold mindset.
        All content on this site is the property of VYRA Wear Pvt Ltd.
      </p>
